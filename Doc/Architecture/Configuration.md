...
[!badge variant="light" text="proxy"] : Configuration d'un proxy pour les commandes ayant besoin d'internet<br>
[!badge variant="ghost" text="threading"] : Active l'utilisation de multi-thread pour les traitements<br>
